...
<div class="wrapper">
<input type="hidden" value="Gas Station" name="category" id="category" />
<?php include 'navigationBar.php';?>
  <div class="content-wrapper">
    <section class="content-header">
		<div class="well well-lg well-gradient">
        <p style="font-size:30px; font-family: Tahoma, Geneva, sans-serif; font-weight:bolder;" id="pageHeader"><i class="fa fa-tint"></i>&nbsp;</p>
		</div>
    </section>
