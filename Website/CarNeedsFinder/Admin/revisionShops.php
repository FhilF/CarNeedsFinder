...
<div class="wrapper">
<input type="hidden" value="<?php echo $idadmin ?>" name="id" id="id" />
<input type="hidden" value="Revision" name="activation" id="activation" />
<?php include 'navigationBar.php';?>
  <div class="content-wrapper">
    <section class="content-header">
<div class="well well-lg well-gradient">
      <p style="font-size:25px;font-family: Tahoma, Geneva, sans-serif; font-weight:bolder;" id="pageHeader"><i class="glyphicon glyphicon-eye-open"></i>&nbsp;For Revision Shops</p>
      <a href="resubmittedShops.php"><button type="button" class="btn btn-edit pull-right">Show Resubmitted Shop List</button></a>
      <br>
      </div>
    </section>
