...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="well well-lg well-gradient">
      <p style="font-size:25px;font-family: Tahoma, Geneva, sans-serif; font-weight:bolder;" id="pageHeader"><i class="glyphicon glyphicon-eye-open"></i>&nbsp;Marked Shops</p>
      <small><span class="glyphicon glyphicon-alert"></span> Please make sure to check the information before making an action</small><br>
      </div>
    </section>
