...
<div class="wrapper">
<input type="hidden" id="activation" name="activation" value="Active" />
<?php include 'navigationBar.php' ?>
<div class="content-wrapper">
      <section class="content-header">
      <div class="well well-lg bg-myblue-color"><p style="font-size:30px; font-weight:bold; font-family:Arial, Helvetica, sans-serif;" id="pageHeader">Active Shops</p></div>
